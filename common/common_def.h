...
/**
  ...
  * @version 
  * @date    
  * @brief    ÈÄöÁî®ÊÄßÂÆö‰πâ,Áî®‰∫éÊï∞ÊçÆÂ§ÑÁêÜ
  ******************************************************************************
  * @attention 	20151110     v1.1   	jgb		÷ÿππ
  * @attention 	20180906     v1.2   	jgb	    ËÑ±Á¶ªÂπ≥Âè∞ÈôêÂà∂
  ******************************************************************************
  */
...
#define  MEM_B( x )  ( *( (uint8_t *) (x) ) )//µ√µΩ÷∏∂®µÿ÷∑…œµƒ“ª∏ˆbyte
#define  MEM_W( x )  ( *( (uint16_t *) (x) ) )//µ√µΩ÷∏∂®µÿ÷∑…œµƒ¡Ω∏ˆbyte

//µ√µΩ“ª∏ˆfield‘⁄Ω·ππÃÂ(struct)÷–µƒ∆´“∆¡ø
#define FPOS( type, field ) ( (uint32_t) &(( type *) 0)-> field )
//µ√µΩ“ª∏ˆΩ·ππÃÂ÷–fieldÀ˘’º”√µƒ◊÷Ω⁄ ˝
