...
static void tmCb(void *arg)
{
    ...
    if(ltlFindAttrRec(LTL_TRUNK_ID_GENERAL_LEVEL_CONTROL, 1, ATTRID_LEVEL_CURRENT_LEVEL, &attrirecord)){
        ...
        ltl_SendReportCmd(&dst_addr, LTL_TRUNK_ID_GENERAL_LEVEL_CONTROL, 1, 0, 
