...
/*
#define USART_USING2   					USART1
#define USART_USING2_IRQ				USART1_IRQn

#define USART_USING2_TX_PORT			GPIOA
#define USART_USING2_TX_PIN				GPIO_Pin_9

#define USART_USING2_RX_PORT			GPIOA
#define USART_USING2_RX_PIN				GPIO_Pin_10
...
#define USART_USING2_PeriphClock_EN()	do{ RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART1, ENABLE);}while(0)
*/
